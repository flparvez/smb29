...
<div className=" bg-white">
    ...
    <p
        className="w-7 text-black h-7 bg-none flex justify-center items-center rounded-full absolute top-0 right-0">
        3x</p>
    <h2 className="text-lg text-center font-bold whitespace-nowrap">{item.price}</h2>
    <hr className="my-2" />
    <div className="text-sm text-gray-700">
        <p className="flex gap-2 items-center"><svg stroke="currentColor" fill="currentColor" stroke-width="0"
        ...
        <p className="flex gap-2 items-center"><svg stroke="currentColor" fill="currentColor" stroke-width="0"
            ...
            </svg> Daily Income {item.dailyIncome} Taka </p>
        <p className="flex gap-2 items-center"><svg stroke="currentColor" fill="currentColor" stroke-width="0"
                version="1" viewBox="0 0 48 48" enable-background="new 0 0 48 48" height="1em"
                width="1em" xmlns="http://www.w3.org/2000/svg">
                <polygon fill="#8BC34A"
            ...
            </svg> Validity 130 days </p>
    </div>
                    <button  data-id="86"  data-title="Basic"  data-price="500 BDT"
